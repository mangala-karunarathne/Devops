...
c. There are two website backups /home/thor/ecommerce and /home/thor/apps on jump_host. Set them up on Apache in a way that ecommerce should work on the link
http://localhost:8087/ecommerce/
and apps should work on the link
http://localhost:8087/apps/
on the mentioned app server.
d. Once configured, you should be able to access the websites using curl command on the respective app server.
---
